...
### Two-Role Model: Consumer vs Author

Identified and formalized the two distinct interaction roles with the platform:

| Role | Prompt Document | Purpose |
|------|-----------------|---------|
...
**Nomenclature:** Both use `{ROL}-PROMPT.md` pattern to maintain consistency and reflect that these are system prompts for LLM interaction.

**Files created/updated:**

| File | Change |
|------|--------|
| `model/CONSUMER-PROMPT.md` | Renamed from SYSTEM-PROMPT.md, v1.2 |
| `model/AUTHOR-PROMPT.md` | **NEW** - Complete prompt for C4E authoring sessions |
| `model/README.md` | Updated to v5.1, documents two-role model |

**AUTHOR-PROMPT.md includes:**
- Critical rules (always read authoring guides, follow checklists, maintain traceability)
- Session patterns (how to respond to different authoring requests)
- Quality gates (before/after creating assets)
- Common mistakes to avoid

**Usage:** Load `AUTHOR-PROMPT.md` at the start of any session where C4E team creates or modifies model assets.

### GitHub Pages Updates

Updated all documentation references for new nomenclature:

| File | Change |
|------|--------|
| `_sidebar.md` | Updated Model section, added AUTHOR-PROMPT, added Flow Guide |
| `README.md` | Updated repository structure |
| `GETTING-STARTED.md` | Updated model structure |
