---
id: adr-code-001-api-design
title: “ADR-CODE-001: API Design - Fusion API Model, Types & Standards"
...
related:
  ...
  - adr-code-013-distributed-transactions
implemented_by:
  - eri-code-001-hexagonal-light-java-spring
  - eri-code-014-api-public-exposure-java-spring
---

# ADR-CODE-001: API Design - Fusion API Model, Types & Standards
...
- **ADR-CODE-004:** Resilience Patterns
- **ADR-CODE-009:** Service Architecture Patterns (Hexagonal Light)
- **ADR-CODE-013:** Distributed Transactions (planned)
