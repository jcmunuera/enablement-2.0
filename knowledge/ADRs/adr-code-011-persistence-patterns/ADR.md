---
id: adr-code-011-persistence-patterns
title: “ADR-CODE-011: Persistence Patterns"
...
# ADR-CODE-011: Persistence Patterns
...
- **ADR-CODE-009:** Hexagonal Light architecture (adapter placement)
- **ADR-CODE-004:** Resilience patterns (required for System API calls)
- **ADR-CODE-001:** API design standards (contract definitions)
