---
id: adr-code-012-api-integration-patterns
title: "ADR-CODE-012: API Integration Patterns"
sidebar_label: API Integration Patterns
version: 1.0
date: 2025-12-01
updated: 2026-02-16
status: Accepted
...
# ADR-CODE-012: API Integration Patterns
...
- **ADR-CODE-001:** API Design Standards (API types)
- **ADR-CODE-004:** Resilience Patterns (Circuit Breaker, Retry, Timeout)
- **ADR-CODE-011:** Persistence Patterns (System API as persistence)
- **ERI-CODE-013:** REST Integration Java Spring (implementation)
